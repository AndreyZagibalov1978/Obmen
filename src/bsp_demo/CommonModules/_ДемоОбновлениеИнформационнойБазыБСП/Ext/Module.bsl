...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ОбновитьПредопределенныеВидыКонтактнойИнформации");
	Методы.Вставить("НастроитьИсториюКонтактнойИнформацииИМногострочноеПоле");
	Методы.Вставить("АктивироватьИсправлениеУстаревшихАдресовПартнеров");
	Методы.Вставить("ОбновитьПредопределенныеВидыКонтактнойИнформацииОрганизаций");
	Методы.Вставить("ПервыйЗапуск");
	Методы.Вставить("ДобавитьВидКонтактнойИнформацииКонтрагентаЮридическийАдрес");
	Методы.Вставить("ДобавитьВидКонтактнойИнформацииКонтрагентаМессенджеры");
	Методы.Вставить("ДобавитьВидКонтактнойИнформацииКонтрагентаТелефон");
	Методы.Вставить("ОперативныйОбработчикСОшибкой");
	Методы.Вставить("ОперативныйОбработчик");
	Методы.Вставить("ВыполнятьВсегдаПриСменеВерсии");
	Методы.Вставить("ОбновитьИспользованиеКонтактнойИнформацииКонтактныхЛицПартнеров");
	Методы.Вставить("ВыполнитьПервоначальноеЗаполнениеВалют");
	Методы.Вставить("ОбновитьПредопределенныеВидыКонтактнойИнформацииФизическихЛиц");
	Методы.Вставить("СоздатьВидыКонтактнойИнформации");
	Методы.Вставить("ИнициализироватьРолиИсполнителей");
	Методы.Вставить("ОбновитьПредопределенныйВидКонтактнойИнформации");
	Методы.Вставить("СнятьПризнакПредопределенныйДляВидовКонтактнойИнформации");
	Методы.Вставить("ЗаполнитьКонстантуИспользоватьНесколькоОрганизаций");
	Методы.Вставить("ОбновитьИспользованиеНаборовСвойствВнешнихПользователей");
	Методы.Вставить("УстановитьНазначенияРолейИсполнителей");
	Методы.Вставить("ЗаполнитьВидКонтактнойИнформацииМеждународныйАдрес");
	Методы.Вставить("ОтложенныйОбработчикСОшибкой");
	Методы.Вставить("ЗаполнитьВидКонтактнойИнформацииВебСайтПартнера");
	Методы.Вставить("ОбновитьПредопределенныеКлючевыеОперации");
	Методы.Вставить("ОбновитьПредопределенныеВидыКонтактнойИнформацииКонтрагентов");
	Методы.Вставить("АктуализироватьВидыКонтактнойИнформации");
