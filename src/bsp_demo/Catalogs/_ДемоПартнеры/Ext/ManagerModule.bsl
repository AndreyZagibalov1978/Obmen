...
Процедура ПриОпределенииМетодовРазрешенныхДляВызоваКакПроизвольныйКод(Методы) Экспорт
	...
	Методы.Вставить("ЗарегистрироватьДанныеКОбработкеДляРасчетаСроковХраненияПерсональныхДанных");
	Методы.Вставить("ЗарегистрироватьДляРасчетаСроковХраненияПерсональныхДанных");
